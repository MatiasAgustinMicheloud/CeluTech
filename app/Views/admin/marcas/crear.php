        ...
        <div class="col-md-6">
            <div class="card shadow">
                <div class="card-body p-5">
                    <h2 class="text-center text-uppercase mb-4">Nueva Marca</h2>
                    ...
                    <form action="<?= base_url('admin/marcas/guardar') ?>" method="POST">
                        <?= csrf_field() ?>
                        <div class="mb-3">
                            <label class="form-label">Nombre de la marca</label>
                            <input type="text" name="marca_nombre" class="form-control" value="<?= isset($old) ? $old['marca_nombre'] : '' ?>">
                        </div>
