              ...
              <div class="col-lg-2 col-sm-6 pb-3">
                <div class="footer-menu text-uppercase">
                  ...
                  <ul class="menu-list list-unstyled text-uppercase">
                    ...
                    <li class="menu-item pb-2"><a href="<?= base_url('comercializacion') ?>">Comercialización</a></li>
                    <li class="menu-item pb-2"><a href="<?= base_url('terminos') ?>">Términos y condiciones</a></li>
                    <li class="menu-item pb-2"><a href="<?= base_url('quienes-somos') ?>">Quiénes somos</a></li>
                    <li class="nav-item"><a href="<?= base_url('contacto') ?>">Contacto</a></li>
                  </ul>
                </div>
              </div>
